...
def register_model_version(
    ...
    with mlflow.start_run() as run:
        ...
        model_version = client.get_model_version(model_name, "1")  # Start with version 1
...
def promote_to_production(model_name: str, version: str = "latest") -> bool:
    """
    ...
    try:
        ...
        print(f"Successfully promoted {model_name} version {model_version.version} to Production")
        return True

...
def analyze_mid_range_spreads():
    ...
    mid_range_df["actual_spread_line"] = (
        mid_range_df["home_points"] - mid_range_df["away_points"]
    )
    mid_range_df["prediction_error"] = (
        mid_range_df["Spread Prediction"] - mid_range_df["actual_spread_line"]
    )

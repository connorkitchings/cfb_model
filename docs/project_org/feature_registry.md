...
| opponent_adjusted_v1        | `conf/features/opponent_adjusted_v1.yaml`    | 🏆 **active** (champion) | Phase 2 | 2025-12-07     | +2.38%      | Adds 4-iteration opponent adjustment. ROI -0.97%. Passed Phase 2.                                |
| **V2 Candidates (Phase 2)** |                                              |                          |         |                |             |                                                                                                  |
| recency_weighted_v1         | `conf/features/recency_weighted_v1.yaml`     | 📋 proposed              | Phase 2 | -              | TBD         | Adds last-3-game recency weighting (3/2/1). Tests if recent form improves ROI.                   |

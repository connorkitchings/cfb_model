...
def main(cfg: DictConfig):
    ...
    target_col = cfg.get("target") or cfg.model.get("target")
    if not target_col:
        log.error("Target column not found in config.")
        return
    ...
    csv_path = output_dir / f"shap_importance_{model_name}.csv"
    ...
    plot_path = output_dir / f"shap_summary_{model_name}.png"
